                    ...
                    <li>
                        <a href="#"
                            ...
                            <div class="flex-1 min-w-0 relative text-gray-500">
                                <h4 class="text-black font-semibold dark:text-red dark-text">David Peterson</h4>
        ...
        <div class="lg:w-8/12 bg-white dark:bg-gray-800">
            ...
            <div class="px-5 py-4 flex uk-flex-between">
                ...
                <a href="#" class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0 relative text-gray-500">
                        <h4 class="font-semibold text-black text-lg dark-text">Sindy Forest</h4>
                ...
                <a href="#" class="flex hover:text-red-400 items-center leading-8 space-x-2 text-red-500 font-medium">
                    <i class="uil-trash-alt dark-i"></i> <span class="lg:block hidden dark-text"> Delete Conversation </span>
                </a>
            </div>
            ...
            <div class="border-t dark:border-gray-600">
                ...
                <div class="lg:p-8 p-4 space-y-5">
                    ...
                    <h3 class="lg:w-60 mx-auto text-sm uk-heading-line uk-text-center dark-time lg:pt-2"><span> 28 June, 2018
                        </span></h3>
