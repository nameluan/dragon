<header>
    <div class="header_inner">
        ...
        <div class="right-side lg:pr-4">
             <!-- upload -->
            <a href="#"
                class="bg-blue-400 flex font-bold hidden hover:bg-blue-600 hover:text-white inline-block items-center lg:block max-h-10 mr-4 px-4 py-2 rounded shado text-white">
